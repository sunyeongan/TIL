...
public class LinearProbing2<K,V>{
	...
	private int M = 13; // 테이블 크기를 소수로 설정함 
	private K[] a = (K[]) new Object[M]; //Key 값을 저장하는 테이블 
	private V[] d = (V[]) new Object[M]; // Value값을 저장하는 테이블 
	public int i = 0, u = 0; 
	public static String  NULL = "null";

	
	public LinearProbing2() {
		super();
	}
	...
	public V delete(K key) {
		...
		do {
			if(a[i].equals(key)) {
				...
				deleted = d[i];
				a[i] = (K)NULL;
				//((Object) a[i]).put((K)new Integer(NULL),(V)new Integer(NULL));
				d[i] = null;
